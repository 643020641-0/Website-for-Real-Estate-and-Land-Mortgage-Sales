              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="15%">
                    ...
                    <a href="form_SellingLeads.php?id=<?= $value['houseandland_id'] ?>" class="btn btn-warning">แก้ไข</a>
                    <a href="delete_SellingLeads.php?id=<?= $value['houseandland_id'] ?>" class="btn btn-danger">ลบ</a>
                    <?php } ?>
                  </td>
                </tr>
                <?php endforeach ?>
