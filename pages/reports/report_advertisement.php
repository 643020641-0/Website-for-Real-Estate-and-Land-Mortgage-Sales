...
if (!empty($_GET['action']) && ($_GET['action']=='Report')) {
  ...
  $TypeHouseAndLands = $conn->query("SELECT users.full_name AS name, COUNT(users.user_id) AS COUNT_num FROM `houseandlands` INNER JOIN users ON houseandlands.user_id = users.user_id WHERE MONTH(houseandlands.Announcement_Date) = '".$DateInput."' AND YEAR(houseandlands.Announcement_Date) = '".$YaerInput."' GROUP BY users.user_id");
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="row col-12 mb-5">
            <div class="col-10">
              <h4>รายงานยอดการลงประกาศขาย รายเดือน</h4>
...
>
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="report_advertisement.php?action=Report" method="POST">
