...
if (!empty($_GET['action']) && ($_GET['action']=='Report')) {
  ...
  $payments = $conn->query("SELECT users.full_name AS full_name, SUM(payments.payment_total) AS payment_total, SUM(payments.token) AS token FROM `payments` INNER JOIN users ON payments.user_id = users.user_id WHERE MONTH(payments.payment_date_time) = '".$DateInput."' AND YEAR(payments.payment_date_time) = '".$YaerInput."' GROUP BY users.user_id;");
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="row col-12 mb-5">
            <div class="col-10">
              <h4>รายงานสรุปยอดค่า Token รายเดือน</h4>
            ...
            <div class="datatable-dashv1-list custom-datatable-overright" style="font-family: 'Kanit'">
                ...
                <table class="table table-bordered" id="example" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <?php 
                        $commission = $value['payment_total'];
                        $sumtotal += $commission;
                    ?>
                    <tr>
                      <td width="35%" align="right"><?= $value['full_name']?></td>
                      <td width="35%" align="center"><?= $value['token']?></td>
                      <td width="35%" align="right"><?= number_format($commission,2) ?></td>
                    </tr>
                    <?php endforeach ?>
                    <tr>
...
>
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="report_commission.php?action=Report" method="POST">
